...
<html>
  ...
  <script>
    ...
    var addedServices = <?php echo $project->addedServicesJS(); ?>;
    ...
    $(document).ready(function(){
        ...
        //add the tabs
        for(var x in addedServices){
            var info = addedServices[x];

            //service.php?action=getArcData&Survey=13080305(0)&uniqueField=Image_&uniqueValue=00174&ArcService=http://services.arcgis.com/Gyd9F6MUsQ0SKcSf/ArcGIS/rest/services/Durham_Roadway_Characteristics
