...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php print $language ?>" lang="<?php print $language ?>">
  <head>
    ...
    <script type="text/javascript" src="/index.html/misc/js/hoverIntent.js"></script>
	<script type="text/javascript" src="/index.html/misc/js/superfish.js"></script>
	<link rel="stylesheet" type="text/css" href="/index.html/misc/css/superfish.css" media="screen">
